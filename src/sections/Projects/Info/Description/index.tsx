...
import ProjectRewards from "sections/Projects/Info/Rewards";
      ...
      <Col xs={12} lg={8} xl={9}>
        <Tabs defaultActiveKey="Description">
          ...
          <Tab eventKey="Policy" title="Policy" className="py-3">
            ...
            <ol>
              <li>
                You cannot request refund on this website after the project funding is ended, unless
                the project owner violates the policy.
              </li>
              <li>
